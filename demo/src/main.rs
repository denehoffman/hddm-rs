...
fn demo_event() -> hddm_s::Hddm {
    hddm_s::Hddm {
        physics_event: vec![hddm_s::PhysicsEvent {
            event_no: 1,
            run_no: 90001,
            reaction: vec![hddm_s::Reaction {
                type_: 0,
                weight: 1.0,

                beam: Some(hddm_s::Beam {
                    type_: Particle::Gamma,
                    momentum: hddm_s::Momentum {
                        e: 9.0,
                        px: 0.0,
                        py: 0.0,
                        pz: 9.0,
                    ...
                    properties: hddm_s::Properties {
                        charge: 0,
                        mass: 0.0,
                    },
                }),

                target: Some(hddm_s::Target {
                ...
                vertex: vec![hddm_s::Vertex {
                    origin: hddm_s::Origin {
                        t: 0.0,
                        vx: 0.0,
                        vy: 0.0,
                        vz: 65.0,
                    },
                    product: vec![hddm_s::Product {
                        id: 1,
                        parentid: 0,
                        pdgtype: 211,
                        ...
                        properties: Some(hddm_s::Properties {
                            charge: 1,
                            mass: 0.13957,
                        }),
                    }],
...
fn write_read(path: &str, compression: hddm::Compression) -> hddm::HddmResult<()> {
    ...
    let mut out = hddm_s::create_with_compression(path, compression)?;
